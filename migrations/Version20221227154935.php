 ...
 */
final class Version20221227154935 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE good (id INT AUTO_INCREMENT NOT NULL, offertype_id INT NOT NULL, goodcategory_id INT NOT NULL, user_id INT NOT NULL, city_id INT NOT NULL, reference VARCHAR(255) NOT NULL, intitule VARCHAR(255) DEFAULT NULL, descriptif VARCHAR(510) DEFAULT NULL, localisation VARCHAR(510) DEFAULT NULL, surface VARCHAR(255) NOT NULL, price VARCHAR(255) NOT NULL, created_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', deleted_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_6C844E92E52A1CB1 (offertype_id), INDEX IDX_6C844E92AFB306D3 (goodcategory_id), INDEX IDX_6C844E92A76ED395 (user_id), INDEX IDX_6C844E928BAC62AF (city_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
